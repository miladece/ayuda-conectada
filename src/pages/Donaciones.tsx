  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <h2 className="text-2xl font-bold mb-6">Donaciones Disponibles</h2>
        ...
        {loading ? (
          <p className="text-center text-gray-600">Cargando donaciones...</p>
        ) : items.length > 0 ? (
          ...
          <p className="text-center text-gray-600">No hay donaciones disponibles</p>
        )}
      </main>
    </div>
  );
